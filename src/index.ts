...
const optionalNullable = {
	...
	arr<T extends Context = Context>(ctx?: T): ArrayContext<T, undefined | null> { return new ArrayContext(ctx).makeOptionalNullable() as any },
	array<T extends Context = Context>(ctx?: T): ArrayContext<T, undefined | null> { return new ArrayContext(ctx).makeOptionalNullable() as any },
	...
	either<CtxA extends Context, CtxB extends Context>(ctxA: CtxA, ctxB: CtxB): EitherContext<CtxA, CtxB, undefined | null> { return new EitherContext(ctxA, ctxB).makeOptionalNullable() as any },
...
const $ = {
	...
	literal<T extends keyof any>(literal: T): LiteralContext<T> { return new LiteralContext(literal) },
	...
	optional: {
		...
		arr<T extends Context = Context>(ctx?: T): ArrayContext<T, undefined> { return new ArrayContext(ctx).makeOptional() as any },
		array<T extends Context = Context>(ctx?: T): ArrayContext<T, undefined> { return new ArrayContext(ctx).makeOptional() as any },
		...
		either<CtxA extends Context, CtxB extends Context>(ctxA: CtxA, ctxB: CtxB): EitherContext<CtxA, CtxB, undefined> { return new EitherContext(ctxA, ctxB).makeOptional() as any },
		...
		literal<T extends keyof any>(literal: T): LiteralContext<T, undefined> { return new LiteralContext(literal).makeOptional() },
	...
	nullable: {
		...
		arr<T extends Context = Context>(ctx?: T): ArrayContext<T, null> { return new ArrayContext(ctx).makeNullable() as any },
		array<T extends Context = Context>(ctx?: T): ArrayContext<T, null> { return new ArrayContext(ctx).makeNullable() as any },
		...
		either<CtxA extends Context, CtxB extends Context>(ctxA: CtxA, ctxB: CtxB): EitherContext<CtxA, CtxB, null> { return new EitherContext(ctxA, ctxB).makeNullable() as any },
		...
		literal<T extends keyof any>(literal: T): LiteralContext<T, null> { return new LiteralContext(literal).makeNullable() },
